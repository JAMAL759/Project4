...
import { createNewVacaction ,ListAllvacation  , UpdateVacation ,deletevacation} from "../../../lib/Vacation/apiVac"
const VacationAdditionC = ({user}) => {
    ...
    async  function  deletVacation (event, id) {
        ...
        try {
         ...
         VacationFetch()
           ...
           console.log("It has worked succesfully")
            ...
            console.log("Their is an error deleting info for vacation : " , err)
        }
    }
    ...
    return (
        ...
        {Vacation.map((obj) => {
            ...
            return(
                ...
                <form onSubmit={(e) => (deletVacation(e, obj._id ))}>
